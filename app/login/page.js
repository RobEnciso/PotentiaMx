      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 sm:p-10">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-lg font-semibold text-slate-700 bg-white border-2 border-slate-200 hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm hover:shadow mt-6"
          >
