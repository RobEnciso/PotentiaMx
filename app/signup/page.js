        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8">
          ...
          <div className="mb-6">
            <button
              ...
              type="button"
              className="w-full flex items-center justify-center gap-3 px-6 py-3 border-2 border-slate-200 rounded-lg hover:bg-slate-50 hover:border-slate-300 transition-all font-medium text-slate-700"
            >
