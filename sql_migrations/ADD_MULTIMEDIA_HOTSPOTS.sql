...
ADD COLUMN IF NOT EXISTS backlink_id INTEGER REFERENCES hotspots(id) ON DELETE SET NULL;
...
WHERE table_name = 'hotspots'
  AND column_name IN ('hotspot_type', 'audio_ambient_url', 'audio_narration_url', 'create_backlink')
